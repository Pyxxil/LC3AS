...
Diagnostics::HighlightContext::HighlightContext(SelectionContext t_selector,
                                                ...
                                                std::string changer)
    : Context(std::move(t_selector.file_information), t_selector.message,
              t_selector.line, HIGHLIGHT),
      highlighter(t_highlighter), highlight_length(t_highlight_length - 1),
