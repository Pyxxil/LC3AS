            ...
            if (tokenized_line.front()->type() == Token::ADDON_INCLUDE) {
                if (tokenized_line.front()->valid_arguments(tokenized_line)) {
                    ...
                    if (file_is_already_open) {
                        ...
                        // TODO: Move the code to check if the file can be opened into the
                        // TODO: lexer's constructor (only for constructors given with a parent)
                        Lexer lexer(
...
std::shared_ptr<Token> Lexer::tokenize(std::string &word, size_t line_number, size_t column)
{
    ...
    if (0u != hashed) {
        switch (hashed) {
        case hash("ADD", 3):return std::make_shared<Add>(word, copy, file_name, line_number, column);
        case hash("AND", 3):return std::make_shared<And>(word, copy, file_name, line_number, column);
        case hash("NOT", 3):return std::make_shared<Not>(word, copy, file_name, line_number, column);
        case hash("JSR", 3):return std::make_shared<Jsr>(word, copy, file_name, line_number, column);
        case hash("JSRR", 4):return std::make_shared<Jsrr>(word, copy, file_name, line_number, column);
        case hash("JMP", 3):return std::make_shared<Jmp>(word, copy, file_name, line_number, column);
        case hash("RET", 3):return std::make_shared<Ret>(word, copy, file_name, line_number, column);
        case hash("ST", 2):return std::make_shared<St>(word, copy, file_name, line_number, column);
        case hash("STR", 3):return std::make_shared<Str>(word, copy, file_name, line_number, column);
        case hash("STI", 3):return std::make_shared<Sti>(word, copy, file_name, line_number, column);
        case hash("LD", 2):return std::make_shared<Ld>(word, copy, file_name, line_number, column);
        case hash("LEA", 3):return std::make_shared<Lea>(word, copy, file_name, line_number, column);
        case hash("LDI", 3):return std::make_shared<Ldi>(word, copy, file_name, line_number, column);
        case hash("LDR", 3):return std::make_shared<Ldr>(word, copy, file_name, line_number, column);
        case hash("PUTS", 4):return std::make_shared<Puts>(word, copy, file_name, line_number, column);
        case hash("PUTSP", 5):return std::make_shared<Putsp>(word, copy, file_name, line_number, column);
        case hash("HALT", 4):return std::make_shared<Halt>(word, copy, file_name, line_number, column);
        case hash("TRAP", 4):return std::make_shared<Trap>(word, copy, file_name, line_number, column);
        case hash("GETC", 4):return std::make_shared<Getc>(word, copy, file_name, line_number, column);
        ...
        case hash(".FILL", 5):return std::make_shared<Fill>(word, copy, file_name, line_number, column);
        case hash(".BLKW", 5):return std::make_shared<Blkw>(word, copy, file_name, line_number, column);
        case hash(".STRINGZ", 8):return std::make_shared<Stringz>(word, copy, file_name, line_number, column);
#ifdef INCLUDE_ADDONS
        case hash(".NEG", 4):return std::make_shared<Neg>(word, copy, file_name, line_number, column);
        case hash(".SUB", 4):return std::make_shared<Sub>(word, copy, file_name, line_number, column);
        case hash(".SET", 4):return std::make_shared<Set>(word, copy, file_name, line_number, column);
        case hash(".LSHIFT", 7):return std::make_shared<Lshift>(word, copy, file_name, line_number, column);
        case hash(".INCLUDE", 8):return std::make_shared<Include>(word, copy, file_name, line_number, column);
#endif
        default:break;
        }
    }
