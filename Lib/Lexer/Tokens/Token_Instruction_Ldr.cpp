...
Ldr::Ldr(std::string &instruction, std::string &instruction_uppercase,
...
bool Ldr::valid_arguments(std::vector<std::shared_ptr<Token>> &tokens)
{
    ...
    if (std::static_pointer_cast<Immediate>(tokens.at(3))->value > 31
        ...
        tokens.at(3)->requires_too_many_bits(6, SIGNED, this,
...
Token::token_type Ldr::type() const { return Token::token_type::OP_LDR; }
