...
Getc::Getc(const std::string& trap,
...
int32_t
Getc::assemble(std::vector<std::shared_ptr<Token>>& tokens,
...
bool
Getc::valid_arguments(std::vector<std::shared_ptr<Token>>& tokens)
{
  if (tokens.size() != 1) {
...
std::string
Getc::disassemble(uint16_t& program_counter,
