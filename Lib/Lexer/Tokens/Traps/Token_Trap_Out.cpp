...
int32_t
Out::assemble(std::vector<std::shared_ptr<Token>>& tokens,
...
bool
Out::valid_arguments(std::vector<std::shared_ptr<Token>>& tokens)
{
  if (tokens.size() > 1) {
...
std::string
Out::disassemble(uint16_t& program_counter,
