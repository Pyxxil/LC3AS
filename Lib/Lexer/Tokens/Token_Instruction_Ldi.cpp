...
Ldi::Ldi(std::string &instruction, std::string &instruction_uppercase, std::string &t_file, int line_number)
                           ...
                           std::uint16_t program_counter)
{
        ...
        assembled.emplace_back(
                static_cast<std::uint16_t>(0xA000 |
...
std::string Ldi::disassemble(std::uint16_t &program_counter,
