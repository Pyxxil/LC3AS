...
Register::Register(std::string &which, std::string &which_uppercase,
                   std::string &t_file, size_t line_number, size_t column)
    : Token(which, which_uppercase, t_file, line_number, column),
      reg(which.at(1) - '0')
{
...
Token::token_type Register::type() const { return Token::token_type::REGISTER; }
