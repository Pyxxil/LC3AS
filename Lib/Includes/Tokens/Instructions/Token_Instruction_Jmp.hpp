#ifndef TOKEN_OPERATOR_JMP_HPP
#define TOKEN_OPERATOR_JMP_HPP

#include "Tokens/Token_Instruction.hpp"

class Jmp : public Instruction {
public:
  Jmp(const std::string &instruction, const std::string &instruction_uppercase,
      const std::string &t_file, size_t line_number, size_t t_column);

  inline token_type type() const override { return OP_JMP; }
