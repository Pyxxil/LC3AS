#ifndef TOKEN_ADDON_JMPT_HPP
#define TOKEN_ADDON_JMPT_HPP

#include "Tokens/Token_Instruction.hpp"

class Jmpt : public Instruction {
public:
  Jmpt(const std::string &instruction, const std::string &instruction_uppercase,
       const std::string &t_file, size_t line_number, size_t t_column);

  inline token_type type() const override { return ADDON_JMPT; }
