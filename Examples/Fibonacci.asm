...
; A program that iteratively calculates the first 3 to 23 fibonacci numbers,
  ...
  ; NOTE: As R1 is used as the input and the counter, we don't want to overwrite it at
  ...
  ADD R4, R1, x-10        ; We don't want numbers greater than 23.
  ...
  ADD R0, R6          ; Add the digit to it to get the ascii value for it
  OUT                     ; Display it
  ...
  ADD R1, R1, x-1         ; Subtract 1 from the loop counter
